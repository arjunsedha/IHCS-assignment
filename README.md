...
### 3.1. Three Models
#### SIR Model
Suceptible-infected-recovered (SIR) mdoels are highly regarded when learning to understand the spread ofa disease. The model allows others to understand the behaviours of individuals in a population and how they react to an epidmemic/pandemic. 
